...
<asp:Panel ID="PnlDatos" runat="server" BorderStyle="Solid" BorderColor="Black" Width="775px" Height="507px" CssClass="PnlDatos" BackImageUrl="~/Imagenes/Crema.jpg">
    ...
    <asp:TextBox ID="TxtCodigo" runat="server" CssClass="TxtCodigo" ForeColor="#0066FF" AutoCompleteType="Disabled" font-size="Medium" Font-Bold="True" maxlength="4" Width="65px" ReadOnly="True" style="left: -12px; top: 3px"></asp:TextBox>
    <asp:TextBox ID="TxtReferencia" runat="server" CssClass="TxtReferencia" ForeColor="#0066FF" Font-Bold="True" AutoCompleteType="Disabled" font-size="Medium" maxlength="25" style="left: -1px; top: 53px"></asp:TextBox>
    <asp:TextBox ID="TxtDescripcion" runat="server" CssClass="TxtDescripcion" ForeColor="#0066FF" Font-Bold="True" AutoCompleteType="Disabled" font-size="Medium" maxlength="50" style="left: 334px; top: 158px"></asp:TextBox>
</asp:Panel>

<asp:Panel ID="PnlGridview" runat="server" BorderStyle="Outset" Width="764px" CssClass="PnlPanelCaja" Height="216px" ScrollBars="Auto" ToolTip="Buscar Registro">
...
<asp:Panel ID="PnlCuadroGridview" runat="server" BorderStyle="Solid" Width="768px" CssClass="PnlPanel2Caja" Height="218px" ScrollBars="Auto" BorderWidth="1px" BackColor="#999999" ToolTip="Buscar Registros">
</asp:Panel>
